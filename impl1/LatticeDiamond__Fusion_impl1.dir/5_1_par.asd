...
GLOBAL_PRIMARY_1_SIGNALNAME = u_detecter.u1.phase_clock;
GLOBAL_PRIMARY_1_DRIVERTYPE = SLICE;
GLOBAL_PRIMARY_1_LOADNUM = 75;
; Global primary clock #2
GLOBAL_PRIMARY_2_SIGNALNAME = u_detecter/dat_valid;
GLOBAL_PRIMARY_2_DRIVERTYPE = SLICE;
GLOBAL_PRIMARY_2_LOADNUM = 21;
; Global primary clock #3
GLOBAL_PRIMARY_3_SIGNALNAME = u_traffic_light.u_segment.un5_clk_40_i_i;
